const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.ilovenorth.cn' },
    { title: '访问文档中心获取更多帮助', url: 'https://www.ilovenorth.cn' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'ilovenorth.cn',
  HERO_TITLE_4: '专题上线',
  HERO_TITLE_5: '并发专题 带你领略并发魅力',
  HERO_TITLE_LINK: 'https://www.ilovenorth.cn/tag/%E5%B9%B6%E5%8F%91',
