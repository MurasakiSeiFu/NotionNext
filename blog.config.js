...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MurasakiSeiFu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🍃A Man for all season', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ilovenorth.cn', // 网站地址
